...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-linprog-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7138&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-linprog-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-linprog` can be installed with:

```
conda install r-linprog
```

It is possible to list all of the versions of `r-linprog` available on your platform with:
